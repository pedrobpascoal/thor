 ...
 * Original File: dodecahedron_8.off
 * Original Format: off
 * 
 * Model Name: dodecahedron_8
 * Vertices: 20
 * Faces: 20

 * @author ThOR-ModelConverter
 */
class dodecahedron_8 {

	@SuppressWarnings("serial")
	public static Model createModel() {
		BufferedModel model = new BufferedModel("dodecahedron_8", "java");
		BufferedMesh mesh = new BufferedMesh();

		// Add list of vertices:
		mesh.addVertex(0.254019f,-0.608178f,0.8435f);
		mesh.addVertex(-0.492012f,-0.443818f,0.840739f);
		mesh.addVertex(-0.787907f,-0.700642f,0.184936f);
		mesh.addVertex(-0.224741f,-1.023732f,-0.217614f);
		mesh.addVertex(0.419205f,-0.96659f,0.189391f);
		mesh.addVertex(0.908089f,-0.529442f,-0.202376f);
		mesh.addVertex(1.045091f,0.09913f,0.209604f);
		mesh.addVertex(0.640819f,0.050472f,0.855976f);
		mesh.addVertex(0.133837f,0.621906f,0.86094f);
		mesh.addVertex(-0.566293f,0.316421f,0.851521f);
		mesh.addVertex(-0.908089f,0.529442f,0.202376f);
		mesh.addVertex(-1.045091f,-0.09913f,-0.209604f);
		mesh.addVertex(-0.640819f,-0.050472f,-0.855976f);
		mesh.addVertex(-0.133837f,-0.621906f,-0.86094f);
